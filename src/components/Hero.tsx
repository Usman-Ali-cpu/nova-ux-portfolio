      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 mb-6">
            ...
            <span className="text-sm text-cyan-300">Welcome to my digital realm</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <button
            ...
            className="group relative px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full font-semibold text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25"
          >
          ...
          <button
            ...
            className="px-8 py-3 border-2 border-cyan-500/50 rounded-full font-semibold text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-400 transition-all duration-300 hover:scale-105"
          >
            Get In Touch
          </button>
        </div>
